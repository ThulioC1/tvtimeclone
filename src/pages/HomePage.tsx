...
const WatchedEpisodesModal = ({
  ...
  return (
    ...
    >
      <div
        className="w-full sm:max-w-md max-h-[85vh] overflow-y-auto bg-dark-900 rounded-t-2xl sm:rounded-2xl p-5 border border-dark-700 shadow-2xl shadow-black relative z-10"
